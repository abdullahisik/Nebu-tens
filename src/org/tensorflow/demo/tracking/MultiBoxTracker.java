...
public class MultiBoxTracker {
  ...
  public synchronized void drawDebug(final Canvas canvas) {
    ...
    for (final Pair<Float, RectF> detection : screenRects) {
      ...
      canvas.drawLine(25,20,20,25,boxPaint);
      canvas.drawText("hello" + detection.first, rect.left, rect.top, textPaint);
  ...
  public synchronized void draw(final Canvas canvas) {
   ...
   //   canvas.drawLine(trackedPos.left,trackedPos.top,trackedPos.bottom,trackedPos.right,boxPaint);
     // canvas.drawText("NEBU V2.0", (float) (canvas.getWidth() * 0.3), (float) (canvas.getHeight() * 0.8), boxPaint);
